...
bool eval (string result_sha,Mail* mail) {
  ...
  string gt_noc_dir      = "/media/xiyu/data/training/disp_noc";
  string gt_occ_dir      = "/media/xiyu/data/training/disp_occ";
  string gt_refl_noc_dir = "/media/xiyu/data/training/disp_refl_noc";
  string gt_refl_occ_dir = "/media/xiyu/data/training/disp_refl_occ";
  string gt_img_dir      = "/media/xiyu/data/training/image_0";
